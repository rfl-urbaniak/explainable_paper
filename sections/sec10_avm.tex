...
distributions with real feature identities withheld under NDA; the two panels
rank their own top variables independently, so only the shape of each
distribution is comparable, not which specific features receive attribution in
one panel versus the other.
