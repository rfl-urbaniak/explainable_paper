...
impact function $ci$ whose expectation is the \ourapproach score, and show how the
choice of $ci$ generalises the framework from binary to continuous outcomes; (5) compute
