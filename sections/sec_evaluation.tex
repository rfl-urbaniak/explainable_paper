...
synthetic model with three archetypes and an irrelevance control.} Each row is one archetype desideratum (linear
...
necessity term under witness pinning. The verdict holds across $20$ factual worlds
drawn from the prior, with lockdown ahead in $18$ of them and a mean gap of
$+0.701$ (standard error $0.111$).
