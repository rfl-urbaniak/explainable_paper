...
rather than uniformly, would exploit exactly this sparsity, but building it requires
the graph's relevance structure to be legible in the first place, which trades away
desideratum (iii)'s reach into grey-box models where structural facts are not
cheaply available.
