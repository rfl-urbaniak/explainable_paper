...
tractable but lack context-sensitivity: every intervention propagates downstream
...
Halpern's sense, so AC verdicts can be read off the kernel without enumerating
witnesses.
...
variables (depending on sample budget) and sustains above a $0.85$
...
attributions, assigning virtually all responsibility to downstream variables
