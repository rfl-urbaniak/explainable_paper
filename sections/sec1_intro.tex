...
(Figure~\ref{fig:roadmap_inspirations}) that highlights the current stage at the end of
each section --- motivations, definitions, examples and SHAP, actual causality, the
probability of actual causation, and evaluation --- with the supporting appendix material
