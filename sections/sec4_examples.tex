...
\citep{shapley1953} assigns each player $i$ a payoff $\phi_i$, its share of the total
value $v(N) - v(\emptyset)$, and is the unique attribution satisfying four axioms:
\begin{enumerate}
...
Causal SHAP replaces the characteristic function with an interventional
expectation \citep{heskes2020causal}:
\begin{equation}
