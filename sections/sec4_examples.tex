...
\toprule
Person & Feature & PNS & SHAP & ATE & CATE & PCI (no wit.) & PCI (with wit.) \\
\midrule
Alice & \varname{gender} & 0.045 & \phantom{$-$}0.107 & 0.383 & 0.045 & 0.210 & \textbf{0.263} \\
Alice & \varname{credit} & 0.180 & \phantom{$-$}0.174 & 0.518 & 0.180 & 0.240 & \textbf{0.199} \\
Bob   & \varname{gender} & 0.000 & $-$0.107           & 0.383 & 0.045 & 0.038 & \textbf{0.019} \\
Bob   & \varname{credit} & 0.860 & \phantom{$-$}0.343 & 0.518 & 0.855 & 0.228 & \textbf{0.119} \\
\bottomrule
\end{tabular}
...
PNS and PCI values from Table~\ref{tab:pci_decomp}; ATE/CATE computed by direct PSCM evaluation in
