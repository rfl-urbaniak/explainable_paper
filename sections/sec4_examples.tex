...
explain how a model's prediction departs from that model's population-average
output, not the factual outcome an individual actually experienced. When the goal is \emph{causal responsibility
...
Eq.~\eqref{eq:plain_shap_value}, which is what we use throughout except where
noted) averages marginal contributions using the observational conditional
