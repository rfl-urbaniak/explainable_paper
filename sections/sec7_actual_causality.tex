...
with point evaluation at $\mathbf{u}$, and it pins both the sufficiency and the
necessity sums to the same $(\mathbf{C},\mathbf{T})$ pair, mirroring AC's structure of
