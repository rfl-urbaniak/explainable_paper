...
\emph{probability of actual causation}; the empirical comparison (runtime
and verdict recovery as model size grows) was previewed already in
\cref{sec:evaluation}, with the full protocol in Appendix~\ref{sec:ac_benchmark}.
