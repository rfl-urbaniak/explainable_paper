...
\paragraph{Where we are.} Sections~\ref{sec:shap_examples}--\ref{sec:DCE} have
...
$(M,\mathbf{u})\vDash[\mathbf{C}\!\leftarrow\!\mathbf{c}',\,\mathbf{T}'\!\leftarrow\!\mathbf{t}^{\star\prime}]\neg\varphi$;
...
$\Gamma^\star = \arg\max_{\mathbf{C}\subseteq\{\mathbf{S}=\mathbf{s}\},\,\mathbf{T}\subseteq\mathbf{W}}
\Phi(\mathbf{C},\mathbf{T})$. Assume $(\mathbf{C}^\dagger,\mathbf{T}^\dagger)\in\Gamma^\star$
...
$(\mathbf{C}^\dagger,\mathbf{T}^\dagger)\in\Gamma^\star$ as well. The conditions of
