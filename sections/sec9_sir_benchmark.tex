...
(Figure~\ref{fig:sir_heatmap}) that exposes the score geometry before any
...
$y_{\mathrm{nec}}$ in Figure~\ref{fig:sir_heatmap}, against the mask cloud's
...
at the start of this section --- lockdown is the proximate cause of excessive
